...
export function GravityStarsBackground({
  ...
  // Global mousemove so gravity works even when cursor is over page content
  React.useEffect(() => {
    const canvas = canvasRef.current;
  ...
  return (
    <div
      ref={containerRef}
      className={`relative w-full h-full overflow-hidden text-[rgba(232,160,32,0.45)] ${className}`}
    >
